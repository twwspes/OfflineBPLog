...
v1.5.0 (Android version code 14) - prod-1.5 (expo 48), not published and not released, extra modules for import and export xlsx, iOS 13 is minimal supported version
