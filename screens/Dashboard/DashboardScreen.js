...
const DashboardScreen = (props) => {
  ...
  const [showBloodPressureCategory, setShowBloodPressureCategory] =
    useState(false);
  const bloodPressuresUpdateIndicator = useSelector(
  ...
  useEffect(() => {
    const downloadItems = async () => {
      ...
      try {
        setBloodPressures(
          await bloodPressureActions.fetchBloodPressure(
            5000,
            0,
            sinceDateISODateString,
            nowISODateString,
            bloodPressuresPeriodForTable === 'one_day'
              ? null
              : bloodPressuresPeriodForTable === 'one_week'
              ? 7
              : bloodPressuresPeriodForTable === 'one_month'
              ? 4
              : bloodPressuresPeriodForTable === 'three_months'
              ? 3
              : bloodPressuresPeriodForTable === 'six_months'
              ? 6
              : 12,
          ),
        );
    ...
    if (bloodPressures && bloodPressuresAvgMaxMin.length > 0) {
      bloodPressures.forEach((bloodPressure) => {
        if (
          ...
          !isNaN(bloodPressure.systolic_blood_pressure)
        ) {
          ...
          if (
            ...
            !isNaN(bloodPressure.max_systolic_blood_pressure)
          ) {
        ...
        if (
          ...
          !isNaN(bloodPressure.diastolic_blood_pressure)
        ) {
          ...
          if (
            ...
            !isNaN(bloodPressure.max_diastolic_blood_pressure)
          ) {
        ...
        if (!!bloodPressure.pulse && !isNaN(bloodPressure.pulse)) {
          ...
          if (!!bloodPressure.max_pulse && !isNaN(bloodPressure.max_pulse)) {
            bloodPressuresPulseMinMaxForChartTemp.push({
              ...
              q1: Math.round(
                bloodPressure.pulse -
                  (Math.sqrt(3) * bloodPressure.pulse_sd) / 2,
              ),
              q3: Math.round(
                bloodPressure.pulse +
                  (Math.sqrt(3) * bloodPressure.pulse_sd) / 2,
      ...
      <ScrollView>
        ...
        {isLoading ? (
          ...
          <View style={styles.categoryContainer}>
              ...
              !!bloodPressuresAvgMaxMin[0] ? (
                <View style={styles.flatListContainer}>
                  <FlatList
                    ...
                    renderItem={(itemData) =>
                      [5, 6, 7, 9, 10, 11, 13, 14, 15].includes(
                        itemData.index,
                      ) ? (
                        [5, 9, 13].includes(itemData.index) ? (
                          <MainButtonClear
                            ...
                            buttonText={{
                              ...systolicColorStyle(itemData.item)
                                .customFontStyle,
                              ...styles.tableText,
                            }}
                            onPress={() => {}}
                          ...
                          <MainButtonClear
                            ...
                            buttonStyle={styles.button}
                            buttonText={{
                              ...diastolicColorStyle(itemData.item)
                                .customFontStyle,
                              ...styles.tableText,
                            }}
                            onPress={() => {}}
                    ...
                    <View>
                      <VictoryChart
                        ...
                        maxDomain={{
                          y:
                            bloodPressuresAvgMaxMin[0]
                              .max_systolic_blood_pressure + 10,
                        }}
                        minDomain={{
                          y:
                            bloodPressuresAvgMaxMin[0]
                              .min_systolic_blood_pressure - 10,
                        }}
                        domainPadding={10}
                        // containerComponent={
                      ...
                      <VictoryChart
                        ...
                        maxDomain={{
                          y:
                            bloodPressuresAvgMaxMin[0]
                              .max_diastolic_blood_pressure + 10,
                        }}
                        minDomain={{
                          y:
                            bloodPressuresAvgMaxMin[0]
                              .min_diastolic_blood_pressure - 10,
                        }}
                        domainPadding={10}
                        // containerComponent={
                        //     <VictoryZoomContainer
            ...
            {bloodPressures ? (
              !!bloodPressures[1] ? (
                !!bloodPressuresPulseForChart[1] ? (
                  !!bloodPressuresPulseMinMaxForChart[1] ? (
                    <VictoryChart
                      theme={VictoryTheme.material}
                      scale={{ x: 'time' }}
                      maxDomain={{
                        y: bloodPressuresAvgMaxMin[0].max_pulse + 10,
                      }}
                      minDomain={{
                        y: bloodPressuresAvgMaxMin[0].min_pulse - 10,
                      }}
                      domainPadding={10}
                      // containerComponent={
                      //     <VictoryZoomContainer
                    ...
                    >
                      <ChartAxis
                        ...
                        maxValue={bloodPressuresPulseForChart[
                    ...
                    >
                      ...
                      <VictoryLegend
                        ...
                        style={{
                          border: { stroke: 'black' },
                          labels: { fontSize: FontSize.smallContent },
                        }}
                        data={[
                          {
                            name: t('heartbeat') + ' (bpm)',
